    ...
    <div class="container mt-5">
      ...
      <form method="POST" action="{{ route('questionnaire.store') }}">
        ...
        <div class="form-group">
          ...
          <div>
            <input type="checkbox" id="other_note" name="note_taking[]" value="Other">
            <label for="other_note">Other</label>
          </div>
        </div>
        <div class="form-group">
          ...
          <div>
            <input type="checkbox" id="other_review" name="review_method[]" value="Other">
            <label for="other_review">Other</label>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div>
            <input type="checkbox" id="other_collaboration" name="collaboration_tools[]" value="Other">
            <label for="other_collaboration">Other</label>
          </div>
        </div>
